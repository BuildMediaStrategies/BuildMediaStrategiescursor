      ...
      <div className="min-h-[80vh] bg-gradient-to-b from-blue-50 to-purple-50">
        <section className="max-w-5xl mx-auto px-6 py-12 sm:py-16">
          ...
          <div className="mt-12 max-w-3xl mx-auto text-center">
            ...
            <p className="text-gray-600 mb-4">We connect your assistant to your knowledge base, FAQs, CRM, and scheduling tools so it can answer questions, qualify leads, and book appointments—24/7.</p>
