    ...
    <section className="py-12 sm:py-16 lg:py-20 px-5 sm:px-6 text-center bg-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12 sm:mb-16">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-sans font-normal text-sky-gradient mb-5 sm:mb-6 tracking-wide">
            Proven Performance<br/>
            <span className="text-sky-gradient">
              Measurable Results
            </span>
          </h2>
          <p className="text-base sm:text-lg font-sans font-light text-black px-4 sm:px-0">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 sm:gap-12 lg:gap-8 place-items-center">
          ...
          <div className="text-center md:text-left">
            <p className="text-sm font-sans font-normal mb-2 text-black">
              Avg Rating
            </p>
            <div className="text-5xl sm:text-6xl font-sans font-bold text-sky-gradient mb-2">
              5.0
            </div>
            <p className="text-sm font-sans font-light text-black">
